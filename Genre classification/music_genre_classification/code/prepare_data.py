...
if __name__ == "__main__":
    in_path = "/content/drive/Shareddrives/musicguru/master-gdc-gdcdatasets-2018655052_gdcfma-metadata-fma_metadata.zip (Unzipped Files)/fma_metadata/tracks.csv"
    genres_path = "/content/drive/Shareddrives/musicguru/master-gdc-gdcdatasets-2018655052_gdcfma-metadata-fma_metadata.zip (Unzipped Files)/fma_metadata/genres.csv"

    out_path = "/content/drive/Shareddrives/musicguru/master-gdc-gdcdatasets-2018655052_gdcfma-metadata-fma_metadata.zip (Unzipped Files)/fma_metadata/tracks_genre.json"
    mapping_path = "/content/drive/Shareddrives/musicguru/master-gdc-gdcdatasets-2018655052_gdcfma-metadata-fma_metadata.zip (Unzipped Files)/fma_metadata/mapping.json"

    df = load("/content/drive/Shareddrives/musicguru/master-gdc-gdcdatasets-2018655052_gdcfma-metadata-fma_metadata.zip (Unzipped Files)/fma_metadata/tracks.csv")
