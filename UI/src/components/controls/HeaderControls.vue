<template lang="pug">
  .header-controls
    ...
    .header-container
      v-btn(outlined small color="pink lighten-3" @click="exportMidi") Save
      v-btn(outlined small color="pink lighten-3" @click="share") Share
...
export default {
  ...
  methods: {
    ...
    share () {
      ...
      const text = 'Check out this song we just generated with #MusicGuru!!'
