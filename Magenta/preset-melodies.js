...
var presetMelodies = {
    ...
    'Happy' : {
        notes: [
            ...
            {pitch: 58, quantizedStartStep: 2, quantizedEndStep: 4},
            ...
            {pitch: 64, quantizedStartStep: 10, quantizedEndStep: 12},
            {pitch: 64, quantizedStartStep: 15, quantizedEndStep: 16},
            {pitch: 58, quantizedStartStep: 16, quantizedEndStep: 18},
            {pitch: 64, quantizedStartStep: 19, quantizedEndStep: 20},
            {pitch: 61, quantizedStartStep: 20, quantizedEndStep: 22},
            {pitch: 60, quantizedStartStep: 22, quantizedEndStep: 24},
            {pitch: 64, quantizedStartStep: 24, quantizedEndStep: 26},
            {pitch: 64, quantizedStartStep: 26, quantizedEndStep: 28},
    ...
    'Jingle' : {
        notes: [
            ...
            {pitch: 62, quantizedStartStep: 6, quantizedEndStep: 8},
            {pitch: 62, quantizedStartStep: 8, quantizedEndStep: 10},
            {pitch: 62, quantizedStartStep: 10, quantizedEndStep: 12},
            {pitch: 62, quantizedStartStep: 15, quantizedEndStep: 16},
            {pitch: 64, quantizedStartStep: 16, quantizedEndStep: 18},
            {pitch: 60, quantizedStartStep: 19, quantizedEndStep: 20},
            {pitch: 61, quantizedStartStep: 20, quantizedEndStep: 22},
            {pitch: 62, quantizedStartStep: 22, quantizedEndStep: 24}
        ],
        color : [113, 20, 221]
    },
    'Sparse' : {
